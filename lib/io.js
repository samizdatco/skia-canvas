...
function options(pages, {filename='', extension='', format, page, quality, matte, density, outline, msaa, colorType, archive}={}){
  ...
  if (colorType!==undefined){
    bytesPerPixel(colorType) // throw an error if invalid
  }

  return {filename, pattern, format, mime, pages, padding, quality, matte, density, outline, msaa, colorType, archive}
}

//
// ImageData colorType argument
//
...
module.exports = {asBuffer, asDownload, asZipDownload, atScale, bytesPerPixel, options}
