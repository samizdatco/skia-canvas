...
function options(pages, size, {
    filename='', extension='', format, page, quality, matte, density, outline, archive, left, top, width, height
  } = {}) {
  ...
  return {filename, pattern, format, mime, pages, padding, quality, matte, density, outline, archive, bounds}
}
