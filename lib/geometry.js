...
class DOMPoint {
  ...
  matrixTransform(matrix) {
    if (
      (matrix.is2D || (typeof SVGMatrix != 'undefined' && matrix instanceof SVGMatrix)) &&
      this.z === 0 &&
      this.w === 1
    ) {
      return new DOMPoint(
...
class DOMMatrix {
  ...
  static isMatrix3(matrix) {
    if (matrix instanceof DOMMatrix || (typeof SVGMatrix != 'undefined' && matrix instanceof SVGMatrix))
      return true;
  ...
  clone() {
    return new DOMMatrix(this[$values]);
  }
