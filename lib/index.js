...
class Canvas extends RustClass{
  ...
  saveAs(filename, opts={}){
    ...
    let {format, quality, pages, padding, pattern, density, outline, matte, msaa, colorType} = io.options(this.pages, {filename, ...opts}),
  ...
  toBuffer(extension="png", opts={}){
    opts = typeof opts=='number' ? {quality:opts} : opts
    let {format, quality, pages, density, outline, matte, msaa, colorType} = io.options(this.pages, {extension, ...opts}),
