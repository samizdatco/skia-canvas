...
// Neon <-> Node interface
//
const _binary = require('@northpool/node-pre-gyp-http');
global._pj_search = __dirname;
const path = require('path')
const _binding_path = _binary.find(path.join(__dirname, './../package.json'))
const skia = require(_binding_path);
...
const ø = Symbol.for('📦'), // the attr containing the boxed struct
      ...
      neon = Object.entries(skia).reduce( (api, [name, fn]) => {
