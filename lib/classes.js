...
class Canvas extends RustClass(native.Canvas){
  ...
  getContext(kind){
    ...
    if (!Canvas.context.has(this)){
      let ctx = new CanvasRenderingContext2D(this, FontLibrary.shared)
...
module.exports = {Canvas, CanvasRenderingContext2D, Path2D, Image, ImageData, CanvasGradient, CanvasPattern, FontLibrary:FontLibrary.shared}
