...
class CanvasRenderingContext2D extends RustClass{
  ...
  reset_transform(){ this.ƒ('resetTransform')}
  ...
  get fillStyle(){
    ...
    return isNaN(style) ? this.cache('get', 'fill') : style
  }
  ...
  get strokeStyle(){
    ...
    return isNaN(style) ? this.cache('get', 'stroke') : style
  }
  ...
  getImageData(...args){ return new ImageData( this.ƒ('getImageData', ...args) ) }
