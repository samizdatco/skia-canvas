...
var fs = require('fs'),
    ...
    {parseFont} = require('./text'),
    native = require('../native'),
    {$, RustClass, toSkMatrix, fromSkMatrix} = require('./utils');

const REPR = inspect.custom

class CanvasRenderingContext2D extends RustClass(native.CanvasRenderingContext2D, "getImageData", "measureText"){
  ...
  measureText(...args){
    return new TextMetrics( $(this, 'measureText', ...args) )
  }
...
class TextMetrics{
  constructor([
    ...
    haging, alphabetic, ideographic
  ]){
    defProp(this, "width", width)
    defProp(this, "actualBoundingBoxLeft", left)
    defProp(this, "actualBoundingBoxRight", right)
    defProp(this, "actualBoundingBoxAscent", ascent)
    defProp(this, "actualBoundingBoxDescent", descent)
    defProp(this, "fontBoundingBoxAscent", fontAscent)
    defProp(this, "fontBoundingBoxDescent", fontDescent)
    defProp(this, "emHeightAscent", emAscent)
    defProp(this, "emHeightDescent", emDescent)
    defProp(this, "hangingBaseline", haging)
    defProp(this, "alphabeticBaseline", alphabetic)
    defProp(this, "ideographicBaseline", ideographic)
  }
}
