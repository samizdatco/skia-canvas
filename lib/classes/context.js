...
class CanvasRenderingContext2D extends RustClass{
  ...
  getContextAttributes(){
    ...
    return {alpha:true, colorSpace, desynchronized:false, willReadFrequently:false}
  }
  ...
  [REPR](depth, options) {
    ...
    let props = [ "canvas", "currentTransform", "fillStyle", "strokeStyle", "font", "fontStretch", "fontVariant",
                  "direction", "textAlign", "textBaseline", "textWrap", "fontSynthesis", "letterSpacing", "wordSpacing", "globalAlpha",
