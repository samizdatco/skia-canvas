...
function exportOptions(pages, {
  filename='', extension='', format, page, quality, matte, density, msaa,
  fonts, outline, textContrast, textGamma, downsample, colorType
}={}){
  ...
  return {
    ...
    density, msaa, fonts, textContrast, textGamma, downsample, colorType
  }
}
