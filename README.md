...
| [isPointInPath()][isPointInPath()]            | [fillText()][fillText()] ⧸[⚡][drawText]     | [createLinearGradient()][createLinearGradient()]  | [**lineDashOffset**][lineDashOffset]   | [setTransform()][setTransform()]⧸[⚡][transforms] | [bezierCurveTo()][bezierCurveTo()]       | [**letterSpacing**][letterSpacing]                         | [getImageData()][getImageData()]                   | [**shadowBlur**][shadowBlur]                             |
...
| [save()][save()]                              | [fill()][fill()]                            | [createPattern()][createPattern()]                | [**lineWidth**][lineWidth]             | [transform()][transform()] ⧸[⚡][transforms]      | [quadraticCurveTo()][quadraticCurveTo()] | [**textAlign**][textAlign]                                | [drawCanvas() ⚡](#drawcanvascanvas-x-y-)           | [**shadowOffsetX**][shadowOffsetX]                       |
